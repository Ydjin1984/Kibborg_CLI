...
| 1 | **в работе** | Каркас экрана: 1.1 верхняя строка, 1.2 лента со временем сообщений, 1.3 строка работы `♦ действие · время · ↓токены · [stop]`, 1.4 рамка ввода со статусом, 1.5 контекстная строка клавиш — сделаны; остался 1.6 тонкий скроллбар |
