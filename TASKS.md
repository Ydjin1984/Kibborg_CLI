...
| 1 | **в работе** | Каркас экрана: 1.1 верхняя строка (`≡ branch cwd … ctx N% [Panel]`), 1.4 рамка ввода со статусом в нижней границе, 1.5 контекстная строка клавиш — сделаны; остались 1.2 лента без рамок с временем, 1.3 строка работы, 1.6 скроллбар |
